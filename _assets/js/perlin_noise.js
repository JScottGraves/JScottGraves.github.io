    ...
    $.fn.SimpleGradientNoise = function(apply_easing){
      ...
      for (var y = 0; y < 200; y = y + pixel_size){
        for (var x = 0; x < 200; x = x + pixel_size){
          ...
          var lrp0 = lerp(rnd0,rnd3,dist_y);
          var lrp1 = lerp(rnd1,rnd2,dist_y);
          var lrp2 = lerp(rnd0,rnd1,dist_x);
          var lrp3 = lerp(rnd3,rnd2,dist_x);

          var color_scale = (lrp0 + lrp1 + lrp2 + lrp3) / 4;
